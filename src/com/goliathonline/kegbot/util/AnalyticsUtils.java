...
public class AnalyticsUtils {
    ...
    private static final String UACODE = "UA-248504-7";
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "kegbot Analytics trackEvent: "
                            + category + " / " + action + " / " + label + " / " + value);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "kegbot Analytics trackEvent error: "
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "kegbot Analytics trackPageView: " + path);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "kegbot Analytics trackPageView error: " + path, e);
                }
                return null;
            }
        }.execute();
