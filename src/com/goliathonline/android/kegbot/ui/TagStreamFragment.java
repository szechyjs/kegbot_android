...
public class TagStreamFragment extends Fragment {
    ...
    public static final String EXTRA_QUERY = "com.goliathonline.android.kegbot.extra.QUERY";

    public static final String KEGBOT_HASHTAG = "#kegbot";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.post(new Runnable() {
            public void run() {
                ...
                try {
                    mWebView.loadUrl(
                    		"http://mobile.twitter.com/searches?q="
